...
!  (should be close enough)
	write(6,*)'targ%musc(i) = ',targ%musc_max
...
C Better form for beta .ne. 1
	...
	if (debug(7))write(6,*) 'theta_sigma = ',theta_sigma,' Es = ',Es,' p = ',p,' beta = ',beta
	if (debug(7))write(6,*) 'epsilon = ',epsilon,' teff = ',teff
