...
! ... extreme theta_e,theta_p,z values for extreme_trip_thru_target.
	...
	if (debug(7)) write(6,*)'@@@@@@@@@@@@@@@@@@ edge%e%xptar%min = ',edge%e%xptar%min,' SPedge%e%xptar%min = ',SPedge%e%xptar%min
        if (debug(7)) write(6,*)' targ%musc_max(2) = ',targ%musc_max(2)
...
! ... Apply limits from direct comparison to acceptance.
	...
	if (debug(7))write(6,*)'*!*!*!*!*!*!*!*!333333 gen%e%xptar%min = ',gen%e%xptar%min
	gen%e%xptar%min = edge%e%xptar%min
	if (debug(7))write(6,*)'*!*!*!*!*!*!*!*!444444 gen%e%xptar%min = ',gen%e%xptar%min
	gen%e%xptar%max = edge%e%xptar%max
	write(6,*)'############gen%e%xptar%min = ',gen%e%xptar%min,' edge%e%xptar%min = ',edge%e%xptar%min
...
! check ALL ntail.eq.0 checks in kinema constraint lines of generate_rad
	...
	g(3) = lambda(3)
	g(0) = g(1)+g(2)+g(3)
	if (debug(7))write(6,*)'lambda = ',lambda,' bt = ',bt
	if (debug(7))write(6,*)'5555 g(i)',g,' g(1) = ',g(1)
! Internal constants
...
C Initialize "gen"
      ...
      if (debug(7))write(6,*)'*!*!*!*!*!*!*!*!111111 gen%e%xptar%min = ',gen%e%xptar%min
      gen%e%xptar%min=xmin
	if (debug(7))write(6,*)'*!*!*!*!*!*!*!*!222222 gen%e%xptar%min = ',gen%e%xptar%min
